...
demo = sio.loadmat('cartpole_demos.mat')
trajectories = demo['trajectories']
horizon = trajectories[0, 0]['horizon'][0, 0][0][0]
...
kkt_iter = list(range(0, len(kkt_loss_list[0])))
kkt_iter = [x*horizon for x in kkt_iter]
