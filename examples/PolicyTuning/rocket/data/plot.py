...
ax.set_xlim(-10,5000)
ax.set_ylim(bottom=-3000,top=30000)
...
demo = sio.loadmat('rocket_oc.mat')
...
ax.legend([line_OCIL,line_pdp],['OCIL (Proposed)','PDP with Poly Policy'],
